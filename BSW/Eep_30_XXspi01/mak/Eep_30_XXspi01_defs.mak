###############################################################################
# File Name  : Eep_XXspi01_defs.mak                                           #
...
# 2014-03-13   1.01     Ou   Adapt it for DrvEep_XXspi01Asr                   #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
EEP_30_XXSPI01_CORE_PATH       =  $(SSC_ROOT)\Eep_30_XXspi01


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)
EEP_30_XXSPI01_OUTPUT_PATH     =  $(GENDATA_DIR)
...
EEP_30_XXSPI01_DEPENDENT_PLUGINS =
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(EEP_XXSPI01_CORE_PATH)  $(EEP_XXSPI01_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
