...
XCP_LOCAL_INLINE FUNC(uint8, XCP_CODE) Xcp_Hlp_EventDaq( uint8_least XcpChannel, uint16 CoreIdx, P2CONST(Xcp_ChannelStruct, AUTOMATIC, XCP_VAR_NOINIT) pXcp,
                                                         uint16_least Daq, Xcp_OdtEntryIdxType EntryIdx );
...
/* Justification for module-specific MISRA deviations:
  ...
  MD_Xcp_5013: rule 6.3
      Reason:     Basic data types are used for Windows/CANoe Emu related platform dependent code which is non AUTOSAR.
      Risk:       The basic data types have unknown range.
      Prevention: The basic data types are used on Windows platform only where the range is known.
*/
