...
/***********************************************************************************************************************
 *  Os_TrapIsUserModeActive()
 **********************************************************************************************************************/
/*! \brief          Returns whether caller of an API is in UserMode.
 ...
 *                  enabled.
 *
 *  \retval         !0  Caller thread runs in user mode.
 *  \retval         0   Caller thread runs in supervisor mode.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
...
OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE, Os_TrapIsUserModeActive,
(
  void
));
...
))
{
  ...
  if(Os_MpIsEnabled() != 0)                                                                                             /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    ...
    {
      /* #30 If caller is in user mode, return IsTrapRequired. */
      if(Os_TrapIsUserModeActive() != 0) {
...
)
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsUserModeActive() != 0)                                                                                            /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  if((Os_TrapIsUserModeActive() != 0) && (tracingEnabled != 0))                                                                 /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsUserModeActive() != 0)                                                                                    /* COV_OS_HALPLATFORMTRAPALWAYSNEEDED */
  {
    Os_TrapPacketType packet;
...
)                                                                                                                       /* COV_OS_UNSUPPORTED93813 */
{
  ...
  /* #10 If a trap is needed: */
  if(Os_TrapIsUserModeActive() != 0)                                                                                            /* COV_OS_UNSUPPORTED93813 */
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  /* #10 If a trap is needed (only in case of tracing enabled): */
  if((Os_TrapIsUserModeActive() != 0) && (tracingEnabled != 0))
  {
    Os_TrapPacketType packet;
