...
#  if (DCM_DIDMGR_MULTISIGNAL_ENABLED == STD_ON) || \
      ...
      (DCM_DIDMGR_READ_VAR_SIZE_DATA_COPY_ENABLED == STD_ON)
...
# define Dcm_UtiMemCopy(srcPtr, tgtPtr, length)                      {Dcm_CfgNetBufferSizeOptType memIter; for(memIter = 0; memIter < (Dcm_CfgNetBufferSizeOptType)(length); ++memIter) {(tgtPtr)[memIter] = (srcPtr)[memIter];}} /* PRQA S 3453, 3458 */ /* MD_MSR_19.7, MD_MSR_19.4 */
...
# define Dcm_UtiMemSetUintX(tgtPtr, uintType, uintValue, elements)   {Dcm_CfgNetBufferSizeOptType memIter; for(memIter = 0; memIter < (Dcm_CfgNetBufferSizeOptType)(elements); ++memIter) {(tgtPtr)[memIter] = (uintType)(uintValue);}} /* PRQA S 3453, 3458 */ /* MD_MSR_19.7, MD_MSR_19.4 */
 ...
 *  \pre            -
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagSetResDataAsU8Rel(Dcm_MsgContextPtrType pMsgContext
                                                               ,Dcm_DiagBufferIndexType index
                                                               ,uint8 value);
...
# if (DCM_DIDMGR_READ_VAR_SIZE_DATA_COPY_ENABLED == STD_ON)                                                                                          /* COV_DCM_UNSUPPORTED XF */
/**********************************************************************************************************************
 *  Dcm_DiagCopyDataContext()
 *********************************************************************************************************************/
/*! \brief          Copies a data context into another one.
 *  \details        -
 *  \param[in]      src           The source data context
 *  \param[in,out]  dst           The destination data context
 *  \context        TASK
 *  \reentrant      FALSE
 *  \synchronous    TRUE
 *  \pre            -
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagCopyDataContext(Dcm_DiagDataContextConstPtrType src
                                                             ,Dcm_DiagDataContextPtrType dst);
# endif
 ...
 *  \pre            -
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagDataContextSetSize(Dcm_DiagDataContextPtrType pDataContext
                                                                ,Dcm_MsgLenType size);
 ...
 *
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagSetResDataAsU8Rel(Dcm_MsgContextPtrType pMsgContext                                                    /* PRQA S 3219 */ /* MD_Dcm_3219 */
                                                               ,Dcm_DiagBufferIndexType index
                                                               ,uint8 value)                                                                         /* COV_DCM_REQUIRED_BY_SAFEBSW TX */
{
 ...
 *
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagCopyDataContext(Dcm_DiagDataContextConstPtrType src                                                    /* PRQA S 3219 */ /* MD_Dcm_3219 */
                                                             ,Dcm_DiagDataContextPtrType dst)
{
  Dcm_UtiMemCopySafe(src->Buffer,
                     dst->Buffer,
                     dst->Usage,
                     dst->Size,
                     src->Usage);
  Dcm_DiagCommitData(dst, src->Usage);
}
# endif
 ...
 *
 *********************************************************************************************************************/
DCM_LOCAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagDataContextSetSize(Dcm_DiagDataContextPtrType pDataContext                                             /* PRQA S 3219 */ /* MD_Dcm_3219 */
                                                                ,Dcm_MsgLenType size)
{
# if (DCM_DEV_RUNTIME_CHECKS == STD_ON)                                                                                                              /* COV_DCM_REQUIRED_BY_SAFEBSW TX */
  if(size > pDataContext->Size)
  {
...
# endif
  {
    pDataContext->Size = size;                                                                                                                       /* SBSW_DCM_POINTER_WRITE_DATA_CONTEXT */
    pDataContext->AvailLen = (Dcm_MsgLenType)(pDataContext->Size - pDataContext->Usage);                                                             /* SBSW_DCM_POINTER_WRITE_DATA_CONTEXT */
  }
}
