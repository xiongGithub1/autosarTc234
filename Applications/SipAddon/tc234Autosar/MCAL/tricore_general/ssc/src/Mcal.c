...
*******************************************************************************/
/* Demo application entry is not used in this integration build. */
...
/* 
   ...
   The mathematical function name is 揅eiling(r)�.
...
void Mcal_EcuMInit()
{
  /* Use Vector EcuM API variant in this project (no PB pointer argument). */
//  EcuM_Init();
  main();
}
...
**                                                                            **
*******************************************************************************/
/* Mcal_SafeErrorHandler is provided by application integration source. */
