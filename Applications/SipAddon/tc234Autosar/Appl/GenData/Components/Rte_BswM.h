...
#  define Rte_InitValue_Provide_BswMRteModeRequestPort_requestedMode (1U)
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_BswM_Provide_BswMRteModeRequestPort_requestedMode(BswM_ESH_RunRequest data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
 ...
 *********************************************************************************************************************/
#  define Rte_Write_Provide_BswMRteModeRequestPort_requestedMode Rte_Write_BswM_Provide_BswMRteModeRequestPort_requestedMode
