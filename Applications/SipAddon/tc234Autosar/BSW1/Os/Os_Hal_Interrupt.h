...
# if defined (OS_CFG_COMPILER_HIGHTEC) || defined (OS_CFG_COMPILER_GNU)
#  pragma GCC diagnostic ignored "-Wuninitialized" /* This suppresses the warning regarding that "State" might
                                                      not be initialized. This warning can be ignored, since the
                                                      pre-condition assures that the "State" parameter is valid. */
# endif
...
# if defined (OS_CFG_COMPILER_HIGHTEC) || defined (OS_CFG_COMPILER_GNU)
#  pragma GCC diagnostic ignored "-Wuninitialized" /* This suppresses the warning regarding that "Level" might
                                                      not be initialized. This warning can be ignored, since the
                                                      pre-condition assures that the "Level" parameter is valid. */
# endif
