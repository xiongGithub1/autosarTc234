...
)
{
  ...
  Os_FifoWriteResultType resultWrite;
  P2CONST(Os_DequeConfigType, AUTOMATIC, OS_CONST) taskQueue;
  ...
  resultWrite = Os_DequeEnqueue(taskQueue, Task);                                                                       /* SBSW_OS_SDR_DEQUEENQUEUE_001 */
  Os_Assert((Os_StdReturnType)(resultWrite == OS_FIFOWRITERESULT_OK));
