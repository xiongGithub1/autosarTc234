...
#endif
#ifndef CANTP_PROCESSOR_TC234
#define CANTP_PROCESSOR_TC234
#endif
...
/* -----------------------------------------------------------------------------
    &&&~ Rx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxNSdu_RxNSdu_2afe666d 0U 
#define CanTpConf_CanTpRxNSdu_RxNSdu_df418442 1U 

 
/* -----------------------------------------------------------------------------
    &&&~ Tx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxNSdu_TxNSdu_7c5f02f8 0U 


/* -----------------------------------------------------------------------------
    &&&~ Rx Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_5a3ff36f 0U 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_389d90ae     0U 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_a6b5883d     1U 


/* -----------------------------------------------------------------------------
    &&&~ TxConfirmation Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_389d90ae 0U 
#define CanTpConf_CanTpTxNPdu_CanTpTxNPdu_5a3ff36f     0U 
...
#define CANTP_EQ2_CANIFTXPDUIDOFTXSDUCFG                              CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN_Tx_3abd61be
...
#define CANTP_EQ2_PDURTXSDUIDOFTXSDUCFG                               PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_Response_MyECU_346f2748
#define CANTP_EQ2_RXFCADDRESSOFTXSDUCFG                               255U
#define CANTP_EQ2_RXFCPDUIDOFTXSDUCFG                                 CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_5a3ff36f
...
#define CANTP_EQ2_TXPDUCONFIRMATIONPDUIDOFTXSDUCFG                    CanTpConf_CanTpTxNPdu_CanTpTxNPdu_5a3ff36f
...
#define CanTp_GetCanIfTxPduIdOfTxSduCfg(Index)                        CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN_Tx_3abd61be
...
#define CanTp_GetPduRTxSduIdOfTxSduCfg(Index)                         PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_Response_MyECU_346f2748
#define CanTp_GetRxFcAddressOfTxSduCfg(Index)                         255U
#define CanTp_GetRxFcPduIdOfTxSduCfg(Index)                           CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_5a3ff36f
...
#define CanTp_GetTxPduConfirmationPduIdOfTxSduCfg(Index)              CanTpConf_CanTpTxNPdu_CanTpTxNPdu_5a3ff36f
