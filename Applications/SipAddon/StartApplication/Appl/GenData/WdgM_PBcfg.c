...
{
  {
    0u /*  WdgMTriggerWindowStart  */ , 
    0u /*  WdgMTicksPerSecond[Hz]=100 , WdgMTriggerWindowStartTicks  */ , 
    1000u /*   (condition value)  WdgMTriggerTimeout  */ , 
    100u /*  WdgMTicksPerSecond[Hz]=100 , WdgMTriggerTimeoutTicks  */ , 
