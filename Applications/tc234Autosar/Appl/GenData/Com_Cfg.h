...
#endif
#ifndef COM_PROCESSOR_TC234
#define COM_PROCESSOR_TC234
#endif
...
#define ComConf_ComSignal_Signal_Rx15bit_OnWrite_a1df81ad             0
#define ComConf_ComSignal_Signal_Rx16bit_Cyclic_a691adb3              1
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_Signal_Tx24bit_Cyclic_85bf3e37              0
#define ComConf_ComSignal_Signal_Tx32bit_OnWrite_b2cd4fc2             1
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComIPduGroup_MyECU_oCAN_Rx_fcef2243                   0
#define ComConf_ComIPduGroup_MyECU_oCAN_Tx_fcef2243                   1
/**\} */
...
#define Com_GetSizeOfActivatableRxComIPdusOfPCConfig()                5U  /**< the number of accomplishable value elements in Com_ActivatableRxComIPdus */
...
#define Com_GetSizeOfHandleRxPduDeferredOfPCConfig()                  5U  /**< the number of accomplishable value elements in Com_HandleRxPduDeferred */
...
#define Com_GetSizeOfRxDefPduBufferOfPCConfig()                       27U  /**< the number of accomplishable value elements in Com_RxDefPduBuffer */
...
#define Com_GetSizeOfRxPduGrpInfoOfPCConfig()                         5U  /**< the number of accomplishable value elements in Com_RxPduGrpInfo */
#define Com_GetSizeOfRxPduInfoOfPCConfig()                            5U  /**< the number of accomplishable value elements in Com_RxPduInfo */
#define Com_GetSizeOfRxSigBufferUInt16OfPCConfig()                    2U  /**< the number of accomplishable value elements in Com_RxSigBufferUInt16 */
#define Com_GetSizeOfRxSigInfoOfPCConfig()                            2U  /**< the number of accomplishable value elements in Com_RxSigInfo */
#define Com_GetSizeOfTxBufferOfPCConfig()                             38U  /**< the number of accomplishable value elements in Com_TxBuffer */
...
#define Com_GetSizeOfTxPduInitValueOfPCConfig()                       38U  /**< the number of accomplishable value elements in Com_TxPduInitValue */
...
#define Com_GetTxPduInfoIdxOfAlwaysActiveTxComIPdus(Index)            ((Com_TxPduInfoIdxOfAlwaysActiveTxComIPdusType)(((Index) + 5U)))  /**< the index of the 1:1 relation pointing to Com_TxPduInfo */
#define Com_GetConfigId()                                             Com_GetConfigIdOfPCConfig()
#define Com_GetPduGrpCnt()                                            Com_GetPduGrpCntOfPCConfig()
#define Com_GetBitLengthOfRxAccessInfo(Index)                         ((Com_BitLengthOfRxAccessInfoType)(((Index) + 15U)))  /**< Bit length of the signal or group signal. */
...
#define Com_GetBusAccOfRxAccessInfo(Index)                            ((Com_BusAccOfRxAccessInfoType)((Com_GetRxPduInfoIdxOfRxAccessInfo(Index) + 1U)))  /**< BUS access algorithm for signal or group signal packing / un-packing. */
#define Com_GetByteLengthOfRxAccessInfo(Index)                        ((Com_ByteLengthOfRxAccessInfoType)(((Index) + 1U)))  /**< Byte length of the signal or group signal. */
...
#define Com_GetApplTypeOfTxSigInfo(Index)                             ((Com_ApplTypeOfTxSigInfoType)((Com_GetBusAccOfTxSigInfo(Index) + 0x02U)))  /**< Application data type. */
#define Com_GetByteLengthOfTxSigInfo(Index)                           ((Com_ByteLengthOfTxSigInfoType)(((Index) + 3U)))  /**< Byte length of the signal or group signal. */
...
#define Com_IsTriggeredOfTxSigInfo(Index)                             (((boolean)(Com_GetBitLengthOfTxSigInfo(Index) == 32U)) != FALSE)  /**< TRUE if signal or group signal has any 'TRIGGERED_*' transfer property. */
...
{
  Com_HandleRxPduDeferredType msg_RxCycle100_0_oCAN_3abd61be[1];
  Com_HandleRxPduDeferredType msg_RxCycle500_20_oCAN_3abd61be[1];
  Com_HandleRxPduDeferredType msg_RxCycle_E2eProf1C_500_10_oCAN_3abd61be[1];
  Com_HandleRxPduDeferredType msg_RxEvent_20_oCAN_3abd61be[1];
  Com_HandleRxPduDeferredType msg_StartAppl_Rx_MyECU_oCAN_3abd61be[1];
...
{
  Com_RxDefPduBufferType msg_RxCycle100_0_oCAN_3abd61be[1];
  Com_RxDefPduBufferType msg_RxCycle500_20_oCAN_3abd61be[6];
  Com_RxDefPduBufferType msg_RxCycle_E2eProf1C_500_10_oCAN_3abd61be[8];
  Com_RxDefPduBufferType msg_RxEvent_20_oCAN_3abd61be[4];
  Com_RxDefPduBufferType msg_StartAppl_Rx_MyECU_oCAN_3abd61be[8];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  Com_HandleRxPduDeferredType raw[5];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Com_RxAccessInfoIndType, COM_CONST) Com_RxAccessInfoInd[2];
#define COM_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Com_RxPduGrpInfoType, COM_CONST) Com_RxPduGrpInfo[5];
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Com_RxPduInfoType, COM_CONST) Com_RxPduInfo[5];
#define COM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Com_TxPduInitValueType, COM_CONST) Com_TxPduInitValue[38];
#define COM_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_RxPduGrpActiveType, COM_VAR_NOINIT) Com_RxPduGrpActive[5];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_RxSigBufferUInt16Type, COM_VAR_NOINIT) Com_RxSigBufferUInt16[2];
#define COM_STOP_SEC_VAR_NOINIT_16BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_TxBufferType, COM_VAR_NOINIT) Com_TxBuffer[38];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
