...
#define CanNmConf_CanNmTxPdu_msg_nm_MyECU_oCAN_TxPdu_3abd61be         0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define CanNmConf_CanNmUserDataTxPdu_NmUsrData_msg_nm_MyECU_oCAN_3abd61be 0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define CanNmConf_CanNmRxPdu_CAN_17d0077e_RxPdu_5c9d081e              0
/**\} */
...
#define CANNM_USE_DUMMY_FUNCTIONS STD_OFF /* /MICROSAR/EcuC/EcucGeneral/DummyFunction */
#endif
...
#define CANNM_DUMMY_STATEMENT(v)  /* PRQA S 3453 */ /* MD_MSR_19.7 */  /* /MICROSAR/EcuC/EcucGeneral/DummyStatementKind */
#endif
#ifndef CANNM_DUMMY_STATEMENT_CONST
#define CANNM_DUMMY_STATEMENT_CONST(v)  /* PRQA S 3453 */ /* MD_MSR_19.7 */  /* /MICROSAR/EcuC/EcucGeneral/DummyStatementKind */
#endif
...
#endif
#ifndef CANNM_PROCESSOR_TC234
#define CANNM_PROCESSOR_TC234
#endif
...
#define CANNM_CPUTYPE_BITORDER_LSB2MSB /* /MICROSAR/EcuC/EcucGeneral/BitOrder */
#endif
...
{
  CanNm_CommStateType CAN_f26020e5[1];
...
{
  CanNm_CoordReadyToSleepStateType CAN_f26020e5[1];
...
{
  CanNm_MsgConfirmationFlagType CAN_f26020e5[1];
...
{
  CanNm_MsgIndicationFlagType CAN_f26020e5[1];
...
{
  CanNm_MsgRequestType CAN_f26020e5[1];
...
{
  CanNm_MsgTimeoutTimerType CAN_f26020e5[1];
...
{
  CanNm_MsgTimerType CAN_f26020e5[1];
...
{
  CanNm_NetworkRestartFlagType CAN_f26020e5[1];
...
{
  CanNm_RepeatMsgTimerType CAN_f26020e5[1];
...
{
  CanNm_TimeoutTimerType CAN_f26020e5[1];
...
{
  CanNm_TxControlStateType CAN_f26020e5[1];
...
{
  CanNm_TxControlStateRequestType CAN_f26020e5[1];
...
{
  CanNm_WaitBusSleepTimerType CAN_f26020e5[1];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(CanNm_MsgRequestUType, CANNM_VAR_NOINIT) CanNm_MsgRequest;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
#define CANNM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
