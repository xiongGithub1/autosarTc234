...
#define PDUR_CANCELTRANSMITFCTPTR                                     STD_ON
...
#define PDUR_SIZEOFCANCELTRANSMITFCTPTR                               STD_ON
...
#define PDUR_CANCELTRANSMITFCTPTRIDXOFTX2LO                           STD_ON
#define PDUR_CANCELTRANSMITFCTPTRUSEDOFTX2LO                          STD_ON
...
#define PDUR_CANCELTRANSMITFCTPTROFPCCONFIG                           STD_ON
...
#define PDUR_SIZEOFCANCELTRANSMITFCTPTROFPCCONFIG                     STD_ON
...
#define PDUR_NO_CANCELTRANSMITFCTPTRIDXOFTX2LO                        255U
...
/** 
  ...
  \{
*/ 
#define PDUR_ISDEF_CANCELTRANSMITFCTPTR                               STD_OFF
...
#define PDUR_ISDEF_CANCELTRANSMITFCTPTRIDXOFTX2LO                     STD_OFF
#define PDUR_ISDEF_CANCELTRANSMITFCTPTRUSEDOFTX2LO                    STD_OFF
...
#define PDUR_ISDEF_CANCELTRANSMITFCTPTROFPCCONFIG                     STD_ON
...
/** 
  ...
  \{
*/ 
#define PDUR_EQ2_CANCELTRANSMITFCTPTR                                 
...
#define PDUR_EQ2_CANCELTRANSMITFCTPTRIDXOFTX2LO                       
#define PDUR_EQ2_CANCELTRANSMITFCTPTRUSEDOFTX2LO                      
...
#define PDUR_EQ2_CANCELTRANSMITFCTPTROFPCCONFIG                       PduR_CancelTransmitFctPtr
...
/** 
  ...
  \{
*/ 
#define PduR_GetCancelTransmitFctPtrOfPCConfig()                      PduR_CancelTransmitFctPtr  /**< the pointer to PduR_CancelTransmitFctPtr */
...
#define PduR_GetSizeOfCancelTransmitFctPtrOfPCConfig()                2UL  /**< the number of accomplishable value elements in PduR_CancelTransmitFctPtr */
...
#define PduR_GetSizeOfTx2LoOfPCConfig()                               9UL  /**< the number of accomplishable value elements in PduR_Tx2Lo */
#define PduR_GetSizeOfTxIf2UpOfPCConfig()                             8UL  /**< the number of accomplishable value elements in PduR_TxIf2Up */
...
/** 
  ...
  \{
*/ 
#define PduR_GetCancelTransmitFctPtr(Index)                           (PduR_GetCancelTransmitFctPtrOfPCConfig()[(Index)])
...
#define PduR_GetCancelTransmitFctPtrIdxOfTx2Lo(Index)                 (PduR_GetTx2LoOfPCConfig()[(Index)].CancelTransmitFctPtrIdxOfTx2Lo)
...
#define PduR_GetSizeOfCancelTransmitFctPtr()                          PduR_GetSizeOfCancelTransmitFctPtrOfPCConfig()
...
#define PduR_IsCancelTransmitFctPtrUsedOfTx2Lo(Index)                 (((boolean)(PduR_GetCancelTransmitFctPtrIdxOfTx2Lo(Index) != PDUR_NO_CANCELTRANSMITFCTPTRIDXOFTX2LO)) != FALSE)  /**< TRUE, if the 0:1 relation has minimum 1 relation pointing to PduR_CancelTransmitFctPtr */
...
#define PduR_GetSrcHndOfTxTp2Src(Index)                               ((PduR_SrcHndOfTxTp2SrcType)(((Index) + 1U)))  /**< handle to be used as parameter for the CopyTxData or TxConfirmation function call. */
...
/** 
  ...
  \{
*/ 
#define PduR_HasCancelTransmitFctPtr()                                (TRUE != FALSE)
...
#define PduR_HasSizeOfCancelTransmitFctPtr()                          (TRUE != FALSE)
...
#define PduR_HasCancelTransmitFctPtrIdxOfTx2Lo()                      (TRUE != FALSE)
#define PduR_HasCancelTransmitFctPtrUsedOfTx2Lo()                     (TRUE != FALSE)
...
#define PduR_HasCancelTransmitFctPtrOfPCConfig()                      (TRUE != FALSE)
...
#define PduR_HasSizeOfCancelTransmitFctPtrOfPCConfig()                (TRUE != FALSE)
...
/** 
  ...
  \{
*/ 
/**   \brief  type used to iterate PduR_CancelTransmitFctPtr */
typedef uint8_least PduR_CancelTransmitFctPtrIterType;
...
/**   \brief  value based type definition for PduR_SizeOfCancelTransmitFctPtr */
typedef uint8 PduR_SizeOfCancelTransmitFctPtrType;
...
/**   \brief  value based type definition for PduR_CancelTransmitFctPtrIdxOfTx2Lo */
typedef uint8 PduR_CancelTransmitFctPtrIdxOfTx2LoType;

/**   \brief  value based type definition for PduR_CancelTransmitFctPtrUsedOfTx2Lo */
typedef boolean PduR_CancelTransmitFctPtrUsedOfTx2LoType;
...
{
  PduR_CancelTransmitFctPtrIdxOfTx2LoType CancelTransmitFctPtrIdxOfTx2Lo;  /**< the index of the 0:1 relation pointing to PduR_CancelTransmitFctPtr */
...
/*lint -restore */
extern CONST(PduR_CancelTransmitFctPtrType, PDUR_CONST) PduR_CancelTransmitFctPtr[2];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(PduR_Tx2LoType, PDUR_CONST) PduR_Tx2Lo[9];
#define PDUR_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(PduR_TxIf2UpType, PDUR_CONST) PduR_TxIf2Up[8];
#define PDUR_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
