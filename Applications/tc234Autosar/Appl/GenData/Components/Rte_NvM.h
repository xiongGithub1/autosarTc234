 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NvM_NvM_RpNotifyJobEnd_NvMBlockDescriptor_StartApplication_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
 ...
 *********************************************************************************************************************/
#  define Rte_Call_NvM_RpNotifyJobEnd_NvMBlockDescriptor_StartApplication_JobFinished Rte_Call_NvM_NvM_RpNotifyJobEnd_NvMBlockDescriptor_StartApplication_JobFinished
