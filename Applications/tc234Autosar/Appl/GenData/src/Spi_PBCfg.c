...
/* EB Channel: SpiChannel_0 Configuration */
  {
    ...
    Spi_DataConfig(8U, /* Data Width */
                   SPI_DATA_LSB_FIRST), /* Transfer Start */
...
/* Job: SpiJob_0 Configuration */
  {
   /* Job End Notification: Spi_JobEndNotification, SPI118 */
    ...
    /* Baud Rate (606060 Hz) Hw configuration Parameters */
    Spi_BaudRateParams(/*TQ*/(0x2U), /*Q*/(0xaU),
              /*A*/(0x1U), /*B*/(0x0U), /*C*/(0x1U)),
...
{
  {
    Spi_BaudRateECON(0xaU, 0x1U, 0x0U, 0x1U,
    SPI_DATA_SHIFT_LEAD,
    SPI_CLK_IDLE_LOW,
