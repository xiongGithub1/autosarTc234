...
static const Mcu_ClockCfgType Mcu_kClockConfiguration0[] =
{
    /*McuClockSettingConfig_0*/
  {
    ...
    },
    {
      ...
      600U, /* ramp up delay for K2 div step 3*/
      600U, /* ramp up delay for K2 div step 4*/
    ...
    /*
      ...
      SPB Clock     = 60.0MHz
    */
    (uint32)0x02220128U,/* CCUCON0 Register Configuration*/
    (uint32)0x08202212U,/* CCUCON1 Register Configuration*/
