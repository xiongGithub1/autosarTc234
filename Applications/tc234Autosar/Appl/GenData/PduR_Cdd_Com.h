...
#if !defined (PDUR_CDD_COM_H)
# define PDUR_CDD_COM_H
 ...
 *           The PDU Router evaluates the Cdd_Com I-PDU handle and identifies the destination(s) of the PDU.\n
 *           The call is routed to a lower IF module using the appropriate I-PDU handle of the destination layer.
 * \param    id                ID of the Cdd_Com I-PDU to be transmitted
 ...
 *                             or the Cdd_ComTxPduId is not valid\n
 *                             or the Cdd_ComTxPduId is not forwarded in this identity\n
