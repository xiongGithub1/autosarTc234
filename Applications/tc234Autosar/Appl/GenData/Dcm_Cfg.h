...
# define DCM_NET_PERIODIC_TX_ENABLED                                           STD_ON
...
# define DCM_NET_UUDT_DELAYTIMER_ENABLED                                       STD_ON
...
# define DCM_DIDMGR_NONPERIODICDYNDID_ENABLED                                  STD_ON
...
# define DCM_DIDMGR_PERIODICDID_CHK_COND_ALL_ENABLED                           STD_ON
...
# define DCM_DIDMGR_MULTISIGNAL_ENABLED                                        STD_ON
...
# define DCM_DIDMGR_OPTYPE_IO_RST2DEFAULT_ENABLED                              STD_ON
/*! Support freeze current state */
# define DCM_DIDMGR_OPTYPE_IO_FRZCURSTATE_ENABLED                              STD_ON
...
# define DCM_DIDMGR_MSIG_OPTYPE_READ_ENABLED                                   STD_ON
/*! Support multiple read check condition operations per DID */
# define DCM_DIDMGR_MSIG_OPTYPE_READ_CHKCOND_ENABLED                           STD_ON
...
# define DCM_DIDMGR_MSIG_OPTYPE_WRITE_ENABLED                                  STD_ON
...
# define DCM_DIDMGR_OPCLS_READ_LENGTH_ASYNC_ENABLED                            STD_ON
...
# define DCM_DIDMGR_22_ACCESS_LOCK_ENABLED                                     STD_ON
/*! Service 0x2A needs DID operation lock */
# define DCM_DIDMGR_2A_ACCESS_LOCK_ENABLED                                     STD_ON
/*! Service 0x2C needs DID operation lock */
# define DCM_DIDMGR_2C_ACCESS_LOCK_ENABLED                                     STD_ON
/*! Service 0x2E needs DID operation lock */
# define DCM_DIDMGR_2E_ACCESS_LOCK_ENABLED                                     STD_ON
/*! Service 0x2F needs DID operation lock */
# define DCM_DIDMGR_2F_ACCESS_LOCK_ENABLED                                     STD_ON
/*! Any DID service needs an operation lock */
# define DCM_DIDMGR_XX_ACCESS_LOCK_ENABLED                                     STD_ON
/*! Any DID manager global data to be stored */
# define DCM_DIDMGR_RAM_CONTEXT_ENABLED                                        STD_ON
...
# define DCM_SVC_2A_SUPPORT_ENABLED                                            STD_ON
...
# define DCM_NET_DELAY_BULK_TRANSMISSION_CONST                                  2u
...
# define DcmConf_DcmDslProtocolRx_PT_msg_diag_RequestGlobal_PP_msg_diag_RequestGlobal_Rx_346f2748_fe6ecc87  0u
# define DcmConf_DcmDslProtocolRx_PT_msg_diag_Request_MyECU_PP_msg_diag_Request_MyECU_Rx_346f2748_fe6ecc87  1u
/*!  ----- Symbolic name values for Tx PduIds -----  */
# define DcmConf_DcmDslPeriodicConnection_DcmDslPeriodicConnection              0u
# define DcmConf_DcmDslProtocolTx_PT_msg_diag_Response_MyECU_PP_msg_diag_Response_MyECU_Tx_346f2748_fe6ecc87  1u
...
# define DCM_NET_NUM_TX_PDUIDS_CONST                                            2u
...
# define DCM_CFGNETTXPDUINFO_SIZE_CONST                                         2u
/*! Size of table Dcm_CfgNetPeriodicTxPduInfo */
# define DCM_CFGNETPERIODICTXPDUINFO_SIZE                                       2u
# define DCM_CFGNETPERIODICTXPDUINFO_SIZE_CONST                                 2u
/*! Size of table Dcm_CfgNetPeriodicTxPduIds */
# define DCM_CFGNETPERIODICTXPDUIDS_SIZE                                        1u
# define DCM_CFGNETPERIODICTXPDUIDS_SIZE_CONST                                  1u
...
# define DCM_CFGSTATESECURITYINFO_SIZE_CONST                                    2u
...
# define DCM_NUM_ITEMS_PER_DYNDID                                               5u
# define DCM_NUM_ITEMS_PER_DYNDID_CONST                                         5u
/*! Total number of DynDID items */
# define DCM_NUM_DYNDID_ITEMS                                                     5u
# define DCM_NUM_DYNDID_ITEMS_CONST                                               5u
/*! Number of dynamically defined DIDs */
# define DCM_NUM_DYNDIDS                                                          1u
# define DCM_NUM_DYNDIDS_CONST                                                    1u
/*! Number of IO control DIDs */
# define DCM_NUM_IODIDS                                                           1u
# define DCM_NUM_IODIDS_CONST                                                     1u
...
# define DCM_CFGDIDMGRDIDLOOKUPTABLE_SIZE_CONST                                19u
/*! Size of table Dcm_CfgDidMgrDidInfo */
# define DCM_CFGDIDMGRDIDINFO_SIZE                                             18u
# define DCM_CFGDIDMGRDIDINFO_SIZE_CONST                                       18u
/*! Size of table Dcm_CfgDidMgrOpInfo */
# define DCM_CFGDIDMGROPINFO_SIZE                                              30u
# define DCM_CFGDIDMGROPINFO_SIZE_CONST                                        30u
/*! Size of table Dcm_CfgDidMgrDidOpClassInfo */
# define DCM_CFGDIDMGRDIDOPCLASSINFO_SIZE                                      49u
# define DCM_CFGDIDMGRDIDOPCLASSINFO_SIZE_CONST                                49u
/*! Size of table Dcm_CfgDidMgrSignalInfo */
# define DCM_CFGDIDMGRSIGNALINFO_SIZE                                          12u
# define DCM_CFGDIDMGRSIGNALINFO_SIZE_CONST                                    12u
/*! Size of table Dcm_CfgDidMgrSignalOpClassInfo */
# define DCM_CFGDIDMGRSIGNALOPCLASSINFO_SIZE                                   63u
# define DCM_CFGDIDMGRSIGNALOPCLASSINFO_SIZE_CONST                             63u
/*! Size of table Dcm_CfgDidMgrOpInfoIoControl */
# define DCM_CFGDIDMGROPINFOIOCONTROL_SIZE                                      1u
# define DCM_CFGDIDMGROPINFOIOCONTROL_SIZE_CONST                                1u
...
# define DCM_CFGRIDMGRRIDLOOKUPTABLE_SIZE                                       5u
# define DCM_CFGRIDMGRRIDLOOKUPTABLE_SIZE_CONST                                 5u
/*! Size of table Dcm_CfgRidMgrRidInfo */
# define DCM_CFGRIDMGRRIDINFO_SIZE                                              4u
# define DCM_CFGRIDMGRRIDINFO_SIZE_CONST                                        4u
/*! Size of table Dcm_CfgRidMgrOpInfo */
# define DCM_CFGRIDMGROPINFO_SIZE                                               7u
# define DCM_CFGRIDMGROPINFO_SIZE_CONST                                         7u
/*! Specifies total number of supported memory operations */
# define DCM_MEMMGR_NUM_MEMORY_OPERATIONS                                       2u
# define DCM_MEMMGR_NUM_MEMORY_OPERATIONS_CONST                                 2u
/*! Specifies total number of memory ranges in single MID or no MID mode */
# define DCM_MEMMGR_MEMMAP_NUM_ENTRIES                                            1u
# define DCM_MEMMGR_MEMMAP_NUM_ENTRIES_CONST                                      1u
/*! Size of table Dcm_CfgMemMgrMemMap */
# define DCM_CFGMEMMGRMEMMAP_SIZE                                               1u
# define DCM_CFGMEMMGRMEMMAP_SIZE_CONST                                         1u
...
# define DCM_CFGDIAGSVCINITIALIZERS_SIZE                                        5u
# define DCM_CFGDIAGSVCINITIALIZERS_SIZE_CONST                                  5u
...
# define DCM_CFGDIAGSVCPOSTPROCESSORS_SIZE                                     12u
# define DCM_CFGDIAGSVCPOSTPROCESSORS_SIZE_CONST                               12u
...
# define DCM_CFGSVC28SUBNETIDLOOKUP_SIZE_CONST                                  3u
/*! Size of table Dcm_CfgSvc28SubNetIdMap */
# define DCM_CFGSVC28SUBNETIDMAP_SIZE                                           2u
# define DCM_CFGSVC28SUBNETIDMAP_SIZE_CONST                                     2u
/*! Specifies the maximum number of DIDs per single request service 0x2A */
# define DCM_SVC_2A_MAX_DID_LIST_LEN                                            5u
# define DCM_SVC_2A_MAX_DID_LIST_LEN_CONST                                      5u
/*! Specifies the maximum number of DIDs that can be scheduled at the same time */
# define DCM_SVC_2A_SCHEDULER_SIZE                                              1u
# define DCM_SVC_2A_SCHEDULER_SIZE_CONST                                        1u
/*! Specifies supported scheduling rates as bitmap */
# define DCM_SVC_2A_SUPPORTED_RATES                                            0x10u
# define DCM_SVC_2A_SUPPORTED_RATES_CONST                                      0x10u
/*! Size of table Dcm_CfgSvc2ASchdRateTime */
# define DCM_CFGSVC2ASCHDRATETIME_SIZE                                          3u
# define DCM_CFGSVC2ASCHDRATETIME_SIZE_CONST                                    3u
/*! Size of table Dcm_CfgNetPeriodicDelayTime */
# define DCM_CFGNETPERIODICDELAYTIME_SIZE                                       3u
# define DCM_CFGNETPERIODICDELAYTIME_SIZE_CONST                                 3u
/*! Specifies the buffers size needed for data extraction of a DDDID source item */
# define DCM_SVC_2C_READ_BUFFER_SIZE                                             47u
/*! Size of table Dcm_CfgSvc2CSubFuncLookUpTable */
# define DCM_CFGSVC2CSUBFUNCLOOKUPTABLE_SIZE                                    4u
# define DCM_CFGSVC2CSUBFUNCLOOKUPTABLE_SIZE_CONST                              4u
/*! Size of table Dcm_CfgSvc2CSubFuncInfo */
# define DCM_CFGSVC2CSUBFUNCINFO_SIZE                                           3u
# define DCM_CFGSVC2CSUBFUNCINFO_SIZE_CONST                                     3u
/*! Size of table Dcm_CfgSvc2CSubFuncExecPrecondTable */
# define DCM_CFGSVC2CSUBFUNCEXECPRECONDTABLE_SIZE                               3u
# define DCM_CFGSVC2CSUBFUNCEXECPRECONDTABLE_SIZE_CONST                         3u
