 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: BswM_Lcfg.c
 *   Generation Time: 2026-05-30 18:13:26
 ...
 * \synchronous TRUE
 */
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_RX_Disable(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_RX_EnableNoinit(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_TX_Disable(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_TX_EnableNoinit(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_Disable_DM(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_Enable_DM(void);
 ...
 * \synchronous TRUE
 */
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CAN_f26020e5_RX(void);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CAN_f26020e5_TX(void);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CAN_f26020e5_RX_DM(void);
...
BSWM_LOCAL VAR(BswM_ESH_RunRequest, BSWM_VAR_NOINIT) BswM_RteRequest_Provide_BswMRteModeRequestPort_requestedMode;
...
CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[20] = {
  ...
  { /*     0 */ BswM_ActionList_CC_AL_CAN_f26020e5_RX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CAN_f26020e5_RX_Disable] */
  { /*     1 */ BswM_ActionList_CC_AL_CAN_f26020e5_RX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CAN_f26020e5_RX_EnableNoinit] */
  { /*     2 */ BswM_ActionList_CC_AL_CAN_f26020e5_TX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CAN_f26020e5_TX_Disable] */
  { /*     3 */ BswM_ActionList_CC_AL_CAN_f26020e5_TX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CAN_f26020e5_TX_EnableNoinit] */
  { /*     4 */ BswM_ActionList_CC_AL_CAN_f26020e5_Disable_DM      },  /* [Priority: 0] */  /* [AL_CC_AL_CAN_f26020e5_Disable_DM] */
  { /*     5 */ BswM_ActionList_CC_AL_CAN_f26020e5_Enable_DM       },  /* [Priority: 0] */  /* [AL_CC_AL_CAN_f26020e5_Enable_DM] */
  ...
  { /*    12 */ BswM_ActionList_ESH_AL_DemInit                     },  /* [Priority: 0] */  /* [AL_ESH_AL_DemInit] */
  { /*    13 */ BswM_ActionList_ESH_AL_InitToWakeup                },  /* [Priority: 0] */  /* [AL_ESH_AL_InitToWakeup] */
  { /*    14 */ BswM_ActionList_ESH_AL_PostRunToPrepShutdown       },  /* [Priority: 0] */  /* [AL_ESH_AL_PostRunToPrepShutdown] */
  { /*    15 */ BswM_ActionList_ESH_AL_ESH_PostRunToPrepCheck      },  /* [Priority: 0] */  /* [AL_ESH_AL_ESH_PostRunToPrepCheck] */
  { /*    16 */ BswM_ActionList_ESH_AL_PostRunToRun                },  /* [Priority: 0] */  /* [AL_ESH_AL_PostRunToRun] */
  { /*    17 */ BswM_ActionList_ESH_AL_ExitPostRun                 },  /* [Priority: 0] */  /* [AL_ESH_AL_ExitPostRun] */
  { /*    18 */ BswM_ActionList_ESH_AL_PrepShutdownToWaitForNvM    },  /* [Priority: 0] */  /* [AL_ESH_AL_PrepShutdownToWaitForNvM] */
  { /*    19 */ BswM_ActionList_INIT_AL_Initialize                 }   /* [Priority: 0] */  /* [AL_INIT_AL_Initialize] */
};
...
CONST(BswM_ImmediateUserType, BSWM_CONST) BswM_ImmediateUser[3] = {
  ...
  { /*     0 */      0x01U,                                    3U,                                      0U },  /* [Name: CC_CanSMIndication_CAN_f26020e5] */  /* [MRP_CC_CanSMIndication_CAN_f26020e5, CANSM_CHANNEL_0] */
...
CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[15] = {
  ...
  { /*     0 */  0U, BswM_Rule_CC_CAN_f26020e5_RX      },  /* [R_CC_CAN_f26020e5_RX, MRP_CC_CanSMIndication_CAN_f26020e5] */
  { /*     1 */  2U, BswM_Rule_CC_CAN_f26020e5_TX      },  /* [R_CC_CAN_f26020e5_TX, MRP_CC_CanSMIndication_CAN_f26020e5] */
  { /*     2 */  1U, BswM_Rule_CC_CAN_f26020e5_RX_DM   },  /* [R_CC_CAN_f26020e5_RX_DM, MRP_CC_CanSMIndication_CAN_f26020e5] */
  { /*     3 */  9U, BswM_Rule_ESH_RunToPostRun        },  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ComMIndication_CAN_f26020e5, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, MRP_ESH_ModeNotification] */
  ...
  { /*     6 */ 13U, BswM_Rule_ESH_WakeupToPrep        },  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification] */
...
CONST(BswM_RulesIndType, BSWM_CONST) BswM_RulesInd[11] = {
  ...
  /*     0 */       0U,  /* [MRP_CC_CanSMIndication_CAN_f26020e5] */
  /*     1 */       1U,  /* [MRP_CC_CanSMIndication_CAN_f26020e5] */
  /*     2 */       2U,  /* [MRP_CC_CanSMIndication_CAN_f26020e5] */
  /*     3 */       3U,  /* [MRP_ESH_State] */
  /*     4 */       5U,  /* [MRP_ESH_State] */
  /*     5 */       6U,  /* [MRP_ESH_State] */
  /*     6 */       7U,  /* [MRP_ESH_State] */
...
VAR(uBswM_ActionListQueueType, BSWM_VAR_NOINIT) BswM_ActionListQueue;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
  ...
  /*     0 */  /* [AL_CC_AL_CAN_f26020e5_RX_Disable] */
  /*     1 */  /* [AL_CC_AL_CAN_f26020e5_RX_EnableNoinit] */
  /*     2 */  /* [AL_CC_AL_CAN_f26020e5_TX_Disable] */
  /*     3 */  /* [AL_CC_AL_CAN_f26020e5_TX_EnableNoinit] */
  /*     4 */  /* [AL_CC_AL_CAN_f26020e5_Disable_DM] */
  /*     5 */  /* [AL_CC_AL_CAN_f26020e5_Enable_DM] */
  /*     6 */  /* [AL_ESH_AL_ExitRun] */
  ...
  /*    12 */  /* [AL_ESH_AL_DemInit] */
  /*    13 */  /* [AL_ESH_AL_InitToWakeup] */
  /*    14 */  /* [AL_ESH_AL_PostRunToPrepShutdown] */
  /*    15 */  /* [AL_ESH_AL_ESH_PostRunToPrepCheck] */
  /*    16 */  /* [AL_ESH_AL_PostRunToRun] */
  /*    17 */  /* [AL_ESH_AL_ExitPostRun] */
  /*    18 */  /* [AL_ESH_AL_PrepShutdownToWaitForNvM] */
  /*    19 */  /* [AL_INIT_AL_Initialize] */
...
VAR(CanSM_BswMCurrentStateType, BSWM_VAR_NOINIT) BswM_CanSMChannelState[1];
  /* Index        Referable Keys  */
  /*     0 */  /* [CANSM_CHANNEL_0, MRP_CC_CanSMIndication_CAN_f26020e5] */
...
VAR(ComM_ModeType, BSWM_VAR_NOINIT) BswM_ComMChannelState[1];
  /* Index        Referable Keys  */
  /*     0 */  /* [COMM_CHANNEL_0, MRP_ESH_ComMIndication_CAN_f26020e5] */
...
VAR(BswM_ModeRequestQueueType, BSWM_VAR_NOINIT) BswM_ModeRequestQueue[3];
  /* Index        Referable Keys  */
  /*     0 */  /* [MRP_CC_CanSMIndication_CAN_f26020e5, CANSM_CHANNEL_0] */
...
VAR(BswM_RuleStatesType, BSWM_VAR_NOINIT) BswM_RuleStates[15];
  /* Index        Referable Keys  */
  /*     0 */  /* [R_CC_CAN_f26020e5_RX, MRP_CC_CanSMIndication_CAN_f26020e5] */
  /*     1 */  /* [R_CC_CAN_f26020e5_TX, MRP_CC_CanSMIndication_CAN_f26020e5] */
  /*     2 */  /* [R_CC_CAN_f26020e5_RX_DM, MRP_CC_CanSMIndication_CAN_f26020e5] */
  /*     3 */  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ComMIndication_CAN_f26020e5, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, MRP_ESH_ModeNotification] */
  ...
  /*     6 */  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification] */
...
FUNC(void, BSWM_CODE) BswM_Init_Gen(void)
{
  ...
  BswM_RteRequest_Provide_BswMRteModeRequestPort_requestedMode = 0xFFU;
...
FUNC(void, BSWM_CODE) BswM_ModeNotificationFct(void)
{
  ...
  if(BswM_RteRequest_Provide_BswMRteModeRequestPort_requestedMode != 0xFFU)
  {
    if(Rte_Write_Provide_BswMRteModeRequestPort_requestedMode(BswM_RteRequest_Provide_BswMRteModeRequestPort_requestedMode) == RTE_E_OK)
    {
      BswM_RteRequest_Provide_BswMRteModeRequestPort_requestedMode = 0xFFU;
    }
  }
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CAN_f26020e5_RX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_RX_Disable(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN_Rx_fcef2243, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN_Rx_fcef2243, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CAN_f26020e5_RX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_RX_EnableNoinit(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN_Rx_fcef2243, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN_Rx_fcef2243, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CAN_f26020e5_TX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_TX_Disable(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN_Tx_fcef2243, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN_Tx_fcef2243, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CAN_f26020e5_TX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_TX_EnableNoinit(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_MyECU_oCAN_Tx_fcef2243, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_MyECU_oCAN_Tx_fcef2243, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CAN_f26020e5_Disable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_Disable_DM(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CAN_f26020e5_Enable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CAN_f26020e5_Enable_DM(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_RunToPostRun(void)
{
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CAN_f26020e5, FALSE);
  /*lint -save -e534 *//* PRQA S 3109, 3200 1 */ /* MD_MSR_14.3, MD_BswM_3200 */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_WakeupToRun(void)
{
  ...
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CAN_f26020e5, TRUE);
  ...
  BswM_RteRequest_Provide_BswMRteModeRequestPort_requestedMode = REQUESTED;
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CAN_f26020e5_RX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CAN_f26020e5_RX(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CAN_f26020e5_RX. */
  if(BswM_GetCanSMChannelState(0) != CANSM_BSWM_NO_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_RX) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_RX, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CAN_f26020e5_RX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CAN_f26020e5_RX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_RX) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_RX, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CAN_f26020e5_RX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CAN_f26020e5_RX_Disable;
    }
  }
  return retVal;
}
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CAN_f26020e5_TX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CAN_f26020e5_TX(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CAN_f26020e5_TX. */
  if(BswM_GetCanSMChannelState(0) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_TX) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_TX, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CAN_f26020e5_TX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CAN_f26020e5_TX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_TX) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_TX, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CAN_f26020e5_TX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CAN_f26020e5_TX_Disable;
    }
  }
  return retVal;
}
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CAN_f26020e5_RX_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CAN_f26020e5_RX_DM(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CAN_f26020e5_RX_DM. */
  if(BswM_GetCanSMChannelState(0) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_RX_DM) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_RX_DM, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CAN_f26020e5_Enable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CAN_f26020e5_Enable_DM;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_RX_DM) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CAN_f26020e5_RX_DM, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CAN_f26020e5_Disable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CAN_f26020e5_Disable_DM;
    }
  }
  return retVal;
}
