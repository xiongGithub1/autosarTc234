 ...
 * DO NOT CHANGE THIS COMMENT!           </USERBLOCK>                                       DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/
  ComM_StateType CAN_f26020e5 = COMM_NO_COM_NO_PENDING_REQUEST;
  
  (void)ComM_GetState(ComMConf_ComMChannel_CAN_f26020e5, &CAN_f26020e5); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  
  if(CAN_f26020e5 != COMM_NO_COM_NO_PENDING_REQUEST)
  {
