 ...
 *       Description: This StartApplication demonstrates following usecases: COM, MEM, DIAG, NM, XCP
 *********************************************************************************************************************/
...
STARTAPPLICATION_LOCAL FUNC(void, StartApplication_CODE) StartApplication_DIAG_OnDataRec_RxData(VAR(uint16, AUTOMATIC) rxDataBuffer);
 ...
 * Description: Called by StartApplication_Cyclic250ms runnable if DIAG usecase is active
 *
 *********************************************************************************************************************/
STARTAPPLICATION_LOCAL FUNC(void, StartApplication_CODE) StartApplication_DIAG_Cyclic(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
    *Rte_Pim_TxDataSigValue() = (uint32) Rte_IrvRead_StartApplication_Cyclic250ms_IrvOccuranceCounterDid();
}

/**********************************************************************************************************************
 *
 * Local Function Entity Name: StartApplication_DIAG_OnDataRec_RxData
 * Description: Called by StartApplication_OnDataRec_RxData runnable if DIAG usecase is active
 *
 *********************************************************************************************************************/
STARTAPPLICATION_LOCAL FUNC(void, StartApplication_CODE) StartApplication_DIAG_OnDataRec_RxData(VAR(uint16, AUTOMATIC) rxDataBuffer) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
    if( *Rte_Pim_DIAG_LastRxData() != rxDataBuffer )
    {
        *Rte_Pim_DIAG_LastRxData() = (uint8) rxDataBuffer;
