...
/* Active mapping for projects using OS/RTE mem sections in this integration. */
#if defined(OS_START_SEC_GLOBALSHARED_VAR_NOINIT_UNSPECIFIED)
...
#if defined(RTE_START_SEC_CODE) || defined(RTE_START_SEC_APPL_CODE) || defined(RTE_START_SEC_BSWM_APPL_CODE) || defined(RTE_START_SEC_COMM_APPL_CODE) || defined(RTE_START_SEC_DCM_APPL_CODE) || defined(RTE_START_SEC_DEMMASTER_0_APPL_CODE) || defined(RTE_START_SEC_DEMSATELLITE_0_APPL_CODE) || defined(RTE_START_SEC_DET_APPL_CODE) || defined(RTE_START_SEC_ECUM_APPL_CODE) || defined(RTE_START_SEC_IOHWAB_APPL_CODE) || defined(RTE_START_SEC_NVM_APPL_CODE) || defined(RTE_START_SEC_OS_OSCORE_CORE0_SWC_APPL_CODE) || defined(RTE_START_SEC_STARTAPPLICATION_APPL_CODE) || defined(RTE_START_SEC_WDGM_APPL_CODE)
# undef RTE_START_SEC_CODE
# undef RTE_START_SEC_APPL_CODE
# undef RTE_START_SEC_BSWM_APPL_CODE
# undef RTE_START_SEC_COMM_APPL_CODE
# undef RTE_START_SEC_DCM_APPL_CODE
# undef RTE_START_SEC_DEMMASTER_0_APPL_CODE
# undef RTE_START_SEC_DEMSATELLITE_0_APPL_CODE
# undef RTE_START_SEC_DET_APPL_CODE
# undef RTE_START_SEC_ECUM_APPL_CODE
# undef RTE_START_SEC_IOHWAB_APPL_CODE
# undef RTE_START_SEC_NVM_APPL_CODE
# undef RTE_START_SEC_OS_OSCORE_CORE0_SWC_APPL_CODE
# undef RTE_START_SEC_STARTAPPLICATION_APPL_CODE
# undef RTE_START_SEC_WDGM_APPL_CODE
# define START_SEC_CODE
#endif

#if defined(RTE_STOP_SEC_CODE) || defined(RTE_STOP_SEC_APPL_CODE) || defined(RTE_STOP_SEC_BSWM_APPL_CODE) || defined(RTE_STOP_SEC_COMM_APPL_CODE) || defined(RTE_STOP_SEC_DCM_APPL_CODE) || defined(RTE_STOP_SEC_DEMMASTER_0_APPL_CODE) || defined(RTE_STOP_SEC_DEMSATELLITE_0_APPL_CODE) || defined(RTE_STOP_SEC_DET_APPL_CODE) || defined(RTE_STOP_SEC_ECUM_APPL_CODE) || defined(RTE_STOP_SEC_IOHWAB_APPL_CODE) || defined(RTE_STOP_SEC_NVM_APPL_CODE) || defined(RTE_STOP_SEC_OS_OSCORE_CORE0_SWC_APPL_CODE) || defined(RTE_STOP_SEC_STARTAPPLICATION_APPL_CODE) || defined(RTE_STOP_SEC_WDGM_APPL_CODE)
# undef RTE_STOP_SEC_CODE
# undef RTE_STOP_SEC_APPL_CODE
# undef RTE_STOP_SEC_BSWM_APPL_CODE
# undef RTE_STOP_SEC_COMM_APPL_CODE
# undef RTE_STOP_SEC_DCM_APPL_CODE
# undef RTE_STOP_SEC_DEMMASTER_0_APPL_CODE
# undef RTE_STOP_SEC_DEMSATELLITE_0_APPL_CODE
# undef RTE_STOP_SEC_DET_APPL_CODE
# undef RTE_STOP_SEC_ECUM_APPL_CODE
# undef RTE_STOP_SEC_IOHWAB_APPL_CODE
# undef RTE_STOP_SEC_NVM_APPL_CODE
# undef RTE_STOP_SEC_OS_OSCORE_CORE0_SWC_APPL_CODE
# undef RTE_STOP_SEC_STARTAPPLICATION_APPL_CODE
