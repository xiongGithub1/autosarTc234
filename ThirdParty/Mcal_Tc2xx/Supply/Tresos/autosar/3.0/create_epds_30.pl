...
# DATE: $Id: create_epds_30.pl,v 1.2 2010/01/08 16:44:37 mawe2550 Exp $
#
...
# provided by Autosar
#
# This version of create_epds is only suiteable for 3.0 epds.
#
...
<AUTOSAR xmlns="http://autosar.org/3.0.2"
         ...
         xsi:schemaLocation="http://autosar.org/3.0.2 autosar.xsd">
  <TOP-LEVEL-PACKAGES>
