...
# DATE: $Id: create_epds_21.pl,v 1.2 2010/01/08 16:44:37 mawe2550 Exp $
#
...
# provided by Autosar
#
# This version of create_epds is only suiteable for 2.1 epds.
#
...
<AUTOSAR xmlns="http://autosar.org/2.1.2" 
         ...
         xsi:schemaLocation="http://autosar.org/2.1.2 autosar.xsd">
  <TOP-LEVEL-PACKAGES>
