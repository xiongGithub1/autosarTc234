...
#*                                                                            **
#*  DESCRIPTION  : This make file is used to build the ECUM driver            **
...
#******************************************************************************/
#*  V0.2.3: 2013.10.15, JN: Updated for I2C 
#*  V0.2.2: 2013.09.25, RK: Updated for SMU 
#*  V0.2.1: 2013.09.24, AJ: Updated for DSADC 
#*  V0.2.0: 2013.07.17, Vani: Updated for HSSL 
#*  V0.1.10:2013.02.25, SGN: CAN changes for VendorApiInfix 
#*  V0.1.9: 2013.02.21, BM : WDG changes for VendorApiInfix 
#*  V0.1.8: 2013.02.21, KP : LIN changes for VendorApiInfix 
#*  V0.1.7: 2013.02.15, SS : ICU changes for VendorApiInfix 
#*  V0.1.6: 2013.01.03, SK : Added support for CanTrcv
#*  V0.1.5: 2012.11.08, basavath: Added support for IOM
#*  V0.1.4: 2012.10.19, AK : support for SENT
#*  V0.1.3: 2012.09.17, AT : Updated for GNU/WINDRIVER compiler
#*  v0.1.2: 2012-05-10, SGN: updated CAN path
#*  v0.1.1: 2011-03-22, PR : updated ON to STD_ON
#*  v0.1.0: 2010-02-15, PrakashG : AI00053231: File/Folder name change 
#*                                    Fr to Fr_17_Eray, fr to fr_17_eray
#*  V0.0.10:2009-10-21, SC       : Added support for RAMTst driver 
#*  V0.0.3: 2009.02.24, Prakash  : Added support for FlexRay driver 
#*  
#*  V0.0.2: 2007.11.05, Prakash  : Added support for CAN driver 
...
ifeq ($(CRC_DELIVERY),STD_ON)
addon_headers += $(CRC_DEP_HEADERS)
ECUM_DEP_INC += ecum_crc_inc 
endif
...
ECUM_DEP_INC += ecum_cantrcv_17_6250gv33_inc 
endif

ifeq ($(CANTRCV_6251G_DELIVERY),STD_ON)
addon_headers += $(CANTRCV_17_6251G_DEP_HEADERS)
ECUM_DEP_INC += ecum_cantrcv_17_6251g_inc 
endif
...
build_ecum_driver : info ecumincpaths $(ECUM_PB_CFG_OBJECTS)


$(ECUM_BASE_PATH)/cfg1/obj/EcuM_PBCfg.$(OBJ_FILE_SUFFIX) : $(ECUM_BASE_PATH)/cfg1/src/EcuM_PBCfg.c $(headers) $(addon_headers)
	@"$(COMPILER)"  $(OUTPUT) $(ECUM_BASE_PATH)/cfg1/obj/EcuM_PBCfg.$(OBJ_FILE_SUFFIX) $(STD_OPT_CC) $(FF_READ)$(ECUM_INC_PATHS_FILE) $(OBJ_CREATION)  $(ECUM_BASE_PATH)/cfg1/src/EcuM_PBCfg.c $(ERROR_REPORT)
	@-rm -f $(ECUM_BASE_PATH)/cfg1/obj/EcuM_PBCfg.ers
...
print:
	@echo $(ECUM_OBJECTS)
info:
	@echo -------------Compiling ECUM Configuration---------------
...
ecum_gpta_inc :	
	@-echo $(GPTA_INCLUDE_PATH) >> $(ECUM_INC_PATHS_FILE)
...
ecum_crc_inc :	
	@-echo $(CRC_INCLUDE_PATH) >> $(ECUM_INC_PATHS_FILE)
